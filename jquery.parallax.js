/**
 * jQuery Mouse Move Parallax
 *
 * @author:		Stephen Band (http://webdev.stephband.info/jparallax/)
 *
 ...
 *
 * Usage:
 * $('#frame').jparallax([options],[item options(N)]);
 *
 * Ex:
 * $('#parallax').jparallax({},{},{ytravel: '0px'},{ytravel: '0px'});
 *
 */
